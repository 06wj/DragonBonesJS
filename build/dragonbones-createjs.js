...
(function(superClass) {
    ...
    var CreatejsSlot = function() {
        superClass.call(this, this);
        this._display = null;
    };

    __extends(CreatejsSlot, superClass, {
        dispose: function() {
            if (this._displayList) {
                var length = this._displayList.length;
                for (var i = 0; i < length; i++) {
    ...
    dragonBones.CreatejsSlot = CreatejsSlot;
})(dragonBones.Slot);
...
(function(superClass){
    ...
    var CreatejsSlot = dragonBones.CreatejsSlot;

    var CreatejsFactory = function(){
        superClass.call(this, this);
    };
    __extends(CreatejsFactory, superClass, {
        _generateArmature:function(){
            var armature = new Armature(new createjs.Container);
            return armature;
        },
        _generateSlot:function(){
            var slot = new CreatejsSlot();
            return slot;
        },
        _generateDisplay:function(textureAtlas, fullName, pivotX, pivotY){
            ...
            var bitmap = new createjs.Bitmap(textureAtlas.texture);
    ...
    dragonBones.CreatejsFactory = CreatejsFactory;
